  ...
  return (
    <section id="portfolio" className="py-12 sm:py-16 lg:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {cases.map((caso, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-white to-medraup-gray-light">
              <CardContent className="p-6 sm:p-8">
                <div className="mb-6">
                  <span className="inline-block bg-red-500 text-white px-3 py-1 rounded-full text-xs sm:text-sm font-medium mb-4">
                    Caso {index + 1}
                  </span>
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">{caso.title}</h3>
                  
                  <div className="mb-6">
                    <h4 className="font-semibold text-red-600 mb-3 text-sm sm:text-base">⚠️ Situação:</h4>
                    <p className="text-gray-600 leading-relaxed bg-red-50 p-4 rounded-lg border-l-4 border-red-500 text-sm sm:text-base">
                      {caso.problem}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="font-semibold text-medraup-blue mb-3 text-sm sm:text-base">✅ Com um PO no projeto:</h4>
                  <div className="space-y-2 bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                    {caso.solution.map((solution, solutionIndex) => (
                      <div key={solutionIndex} className="flex items-start text-gray-700 text-sm sm:text-base">
        ...
        <div className="mt-12 sm:mt-16 text-center max-w-4xl mx-auto px-4">
          <div className="bg-gradient-to-br from-medraup-blue to-medraup-blue-dark rounded-2xl p-6 sm:p-8 text-white">
            <h3 className="text-xl sm:text-2xl font-bold mb-6">O que aprendemos com isso?</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="text-center">
                <p className="text-blue-100 text-sm sm:text-base">Nem todo desenvolvedor é gestor de produto</p>
              </div>
              <div className="text-center">
                <p className="text-blue-100 text-sm sm:text-base">Nem todo projeto começa com código</p>
              </div>
              <div className="text-center">
                <p className="text-blue-100 text-sm sm:text-base">Todo projeto precisa de visão, alinhamento e transparência</p>
              </div>
            </div>
        ...
        <div className="mt-8 sm:mt-12 text-center bg-medraup-gray-light p-6 sm:p-8 rounded-2xl mx-4">
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Evite prejuízos. Tenha um PO com você.</h3>
          ...
          <button 
            ...
            className="w-full sm:w-auto bg-medraup-orange hover:bg-medraup-orange/90 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg transition-all duration-200 transform hover:scale-105"
          >
